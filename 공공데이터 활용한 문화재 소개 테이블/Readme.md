...
```
## 스크롤바 추가
![image](https://github.com/ohseungheon/HTML_CSS_project/assets/132635759/f4aafc5f-ac5b-4a38-8ade-06a243f94d7b)
                ...
                xhr.onreadystatechange = function () {
                    if (this.readyState == 4) {
                        ...
                        for (let i = 0; i < 4; i++) {
                            ...
                            let scroll = `<td><div id ="scrollable-table-container">${values[3]}</div></td>`
                            keyStr += "<th>" + keys[0] + "</th>" + "<th>" + keys[1] + "</th>" + "<th>" + keys[2] + "</th>" + "<th>" + keys[3] + "</th>" + "<th>" + keys[4] + "</th>"
                            valStr += "<td>" + values[0] + "</td>" + "<td>" + values[1] + "</td>" + "<td>" + values[2] + "</td>" + scroll  + "<td>" + values[4] + "</td>"
                            console.log(values[2]);
                            thead.innerHTML = keyStr;
                            arr[i].innerHTML = valStr;
                            valStr = ""
